            ...
            <div class="product-dtls-navtab  border-y border-bdr-clr dark:border-bdr-clr-drk">
                <ul id="user-nav-tabs"
                    ...
                    <li @click="activeTab = 1"
                        ...
                        :class="activeTab === 1 ? 'active' : ''"><router-link to="#"
                            class="duration-300 hover:text-primary">Description</router-link></li>
                    <li @click="activeTab = 2"
                        class="py-3 sm:py-5 lg:6 relative before:absolute before:w-full before:h-[1px] before:bg-title before:top-full before:left-0 before:duration-300 dark:before:bg-white before:opacity-0"
                        :class="activeTab === 2 ? 'active' : ''"><router-link to="#"
                            class="duration-300 hover:text-primary">Vendor Info</router-link></li>
                    <li @click="activeTab = 3"
                        class="py-3 sm:py-5 lg:6 relative before:absolute before:w-full before:h-[1px] before:bg-title before:top-full before:left-0 before:duration-300 dark:before:bg-white before:opacity-0"
                        :class="activeTab === 3 ? 'active' : ''"><router-link to="#"
                            class="duration-300 hover:text-primary">Review</router-link></li>
                    <li @click="activeTab = 4"
                        class="py-3 sm:py-5 lg:6 relative before:absolute before:w-full before:h-[1px] before:bg-title before:top-full before:left-0 before:duration-300 dark:before:bg-white before:opacity-0"
                        :class="activeTab === 4 ? 'active' : ''"><router-link to="#"
                            class="duration-300 hover:text-primary">Shipping</router-link></li>
                </ul>
            </div>
            <div id="content" class="mt-5 sm:mt-8 lg:mt-12 mx-0 sm:mr-5 md:mr-8 lg:mr-12">
                <div v-if="activeTab === 1">
                    <p class="sm:text-lg">Crafted with plush cushioning and ergonomic design, it offers unparalleled
                        comfort for lounging or reading. Its timeless style seamlessly blends with any decor, while the
                        sturdy construction ensures durability for years to come. Whether you're unwinding after a long
                        day or enjoying a leisurely weekend, this chair provides the perfect retreat.</p>
                ...
                <div v-if="activeTab === 3">
                    <div class="max-w-[905px] flex items-start xl:justify-between gap-8 flex-wrap">
                        <div v-for="(item, index) in detailReview" :key="index" class="sm:max-w-[260px] w-full">
                            <svg class="fill-current text-[#E8E9EA] dark:text-white-light" width="60" height="51"
                                viewBox="0 0 60 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
