    ...
    <div class="s-pt-100 2xl:pb-[100px]">
        <div class="container max-w-1366 mx-auto">
            <div class="flex flex-col 2xl:flex-row items-start justify-between gap-10">
                <div class="w-full sm:text-center -order-1 lg:order-none mb-5">
                    <img :src="logo" alt="" class='mx-auto w-[150px] rounded-xl' />
                    <p class="max-w-[522px] sm:mx-auto mt-5">Furnixar is a modern furniture
                    ...
                    <div class="flex items-center sm:justify-center gap-4 mt-5">
                        <router-link to="#"
                            ...
                            aria-label="Facebook">
                            <svg class="fill-current group-hover:text-primary duration-300 " width="9"
                        ...
                        <router-link to="#"
                            class="w-10 h-10 rounded-full border border-black border-opacity-50 flex items-center justify-center group hover:border-primary duration-300"
                            aria-label="Twitter">
                            <svg class="fill-current text-opacity-70 group-hover:text-primary duration-300 group-hover:text-opacity-100"
                        ...
                        <router-link to="#"
                            ...
                            <svg class="fill-current group-hover:text-primary duration-300 " width="18"
                    ...
                    <div>
                        ...
                        <ul class="text-title dark:text-white leading-none flex flex-col gap-4">
                            <li v-for="(item, index) in footerLink3" :key="index"
                                class="duration-100 hover:text-primary inline-block group"><a
                                    class="text-underline-primary" :to="item.link">{{ item.name }}</a></li>
                        </ul>
                    </div>
                    <div>
            ...
            <div class="block 2xl:hidden py-5 text-center mt-14">
                <p>© {{ year }} Club Amantes del Vino y Licores <i class="fa-solid fa-heart text-red-600"></i></p>
            </div>
        </div>
    </div>
</template>
...
import { footerLink3, footerLink4 } from '@/mocks/nav-data.ts';
