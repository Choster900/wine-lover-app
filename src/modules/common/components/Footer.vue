        ...
        <div class="container max-w-1366 mx-auto">
            <div class="flex flex-col 2xl:flex-row items-start justify-between gap-10">
                <div
                    ...
                    <p class="mt-[15px] hidden 2xl:block">© {{ year }} Furnixar Develop with <i
            ...
            <div class="block 2xl:hidden py-5 text-center mt-14">
                <p>© {{ year }} Furnixar Develop with <i class="fa-solid fa-heart text-red-600"></i> by <a
                        href="https://shreethemes.in/" target="_blank" className='ms-1'>Shreethemes</a></p>
            </div>
        </div>
    </div>
</template>
