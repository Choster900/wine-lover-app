<template>
    <div class="inc-dec flex items-center gap-2">
        <button @click="decrement"
            ...
            <svg class="fill-current text-title dark:text-white" width="14" height="2" viewBox="0 0 14 2" fill="none"
        ...
        <input
            ...
            type="text" :value="count" readonly>

        <button @click="increment"
            class="inc w-8 h-8 bg-[#E8E9EA] dark:bg-dark-secondary flex items-center justify-center">
            <svg class="fill-current text-title dark:text-white" width="14" height="14" viewBox="0 0 14 14" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
...
// Inicializar con la prop
const count = ref(props.initialCount ?? 1)

// Reactividad por si la prop cambia (opcional)
